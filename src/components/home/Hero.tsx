  ...
  return (
    <section className="relative pt-20 pb-16 md:pt-32 md:pb-24 overflow-hidden hero-gradient">
      ...
      <div className="absolute inset-0 z-0 opacity-10">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-tunnels-red blur-[100px] animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-64 h-64 rounded-full bg-tunnels-green blur-[100px] animate-pulse" style={{ animationDelay: '1.5s' }}></div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center text-center mb-12 md:mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <Button size="lg" className="bg-tunnels-red hover:bg-tunnels-red/80 text-white font-medium px-8 transform transition-transform hover:scale-105">
              Get Started <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
            <Button variant="outline" size="lg" className="border-white text-white hover:bg-white/10 transform transition-transform hover:scale-105">
        ...
        <div className="relative mx-auto max-w-5xl mt-8 md:mt-16 rounded-lg overflow-hidden border border-tunnels-gray/20 shadow-xl animate-fade-in" style={{ animationDelay: '0.6s' }}>
          <div className="aspect-[16/9] bg-tunnels-black/50 backdrop-blur-sm flex items-center justify-center relative overflow-hidden">
            {/* Hero image */}
            <img 
              ...
              alt="Tech professional working on digital solutions" 
              className="absolute inset-0 w-full h-full object-cover opacity-70"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-tunnels-black to-transparent"></div>
            <div className="p-12 md:p-16 text-center relative z-10">
              <div className="w-16 h-16 md:w-20 md:h-20 bg-tunnels-red/90 rounded-full flex items-center justify-center mx-auto mb-6 animate-bounce">
      ...
      {/* Wave Divider - Using lighter colors for better contrast against dark background */}
